...
public class HiFenceBlock extends AdventureModElements.ModElement {
	@ObjectHolder("adventure:hi_fence")
	public static final Block block = null;
	public HiFenceBlock(AdventureModElements instance) {
		super(instance, 7);
	}
