...
public class HiLogBlock extends AdventureModElements.ModElement {
	@ObjectHolder("adventure:hi_log")
	public static final Block block = null;
	public HiLogBlock(AdventureModElements instance) {
		super(instance, 2);
	}
