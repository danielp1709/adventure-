...
public class HiStairsBlock extends AdventureModElements.ModElement {
	@ObjectHolder("adventure:hi_stairs")
	public static final Block block = null;
	public HiStairsBlock(AdventureModElements instance) {
		super(instance, 5);
	}
