...
public class HiWoodBlock extends AdventureModElements.ModElement {
	@ObjectHolder("adventure:hi_wood")
	public static final Block block = null;
	public HiWoodBlock(AdventureModElements instance) {
		super(instance, 1);
	}
