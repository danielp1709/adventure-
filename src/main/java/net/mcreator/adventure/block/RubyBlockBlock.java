...
public class RubyBlockBlock extends AdventureModElements.ModElement {
	@ObjectHolder("adventure:ruby_block")
	public static final Block block = null;
	public RubyBlockBlock(AdventureModElements instance) {
		super(instance, 3);
	}
