...
import net.mcreator.adventure.item.RubyItem;
...
public class RubyOreBlock extends AdventureModElements.ModElement {
	@ObjectHolder("adventure:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(AdventureModElements instance) {
		super(instance, 2);
	}
